...
function page() {
  ...
  const webData = [
    {
      name: "BackCraft Website",
      description: "backcraft documentaion",
      link: "https://backcraft.vercel.app/"
    }
  ];
  return (
    <>
    ...
    <div className="flex flex-col items-center justify-center gap-4 py-10">
      <h1 className="font-instrument-serif text-4xl tracking-wider">Website</h1>
      <p className="text-xl">All Website related to this project</p>
      <div className="flex flex-wrap gap-4">
        {webData.map((item) => (
          <>
            <div className="max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700">
